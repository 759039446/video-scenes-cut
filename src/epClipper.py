...
class epClipper:
    ...
    def __init__(self, start_time='00:00:00', end_time='END', modes=[0], clip_path='clip', video_path='video'):
    ...
    def detect_scenes(self, output_dir: str) -> Tuple[list, dict]:
        ...
        thumbnails = scenedetect.scene_manager.save_images(scene_list, self.video_manager, num_images=1,
    ...
    def recognize_role(self, input_path: str) -> list:
        ...
        filenames = []
        for data in datas:
            finds = DeepFace.find(data, SCENE_PATH, enforce_detection=False, model_name='Facenet512',
    ...
    def split_video(self, videoname: str):
        ...
        '''
        # init video_manager
        video_path = os.path.join(self.video_path, videoname)
        ...
        # clip scenes
        if 0 in self.modes:
            output_dirs.append(os.path.join(self.clip_path, ep_name))
